...
$body.Add("name", $conf.pref.workingFolderName)               # User preference: settings.json
$body.Add("expiration", (Get-Date).AddDays(1).ToString("o"))  # Date Retention Policy: Keep it until tomorrow.
